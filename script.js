...
let answersRefrence = {
    0: "ببین داداش اگه مشکل داری یعنی هوادار نیستی و دشمنی و حق استفاده از این سرویسو نداری :)",
...
const pollAnswers = [
    ["مشکل داری مشکل داری ما اینجا داریم زحمت میکشیم تو نمیدونی ما به چه باگایی خوردیم"],
